    ...
    , ui(new Ui::AdminWindow)
{
    ...
    connect(ui->searchButton, &QPushButton::clicked,
            this, &AdminWindow::onSearchButtonClicked);

    connect(ui->updateStatusButton, &QPushButton::clicked,
            this, &AdminWindow::onUpdateStatusButtonClicked);

    connect(ui->filterButton, &QPushButton::clicked,
            this, &AdminWindow::onFilterButtonClicked);
}
